...
{
    public class SampleProfilesController : Controller
    {
        ...
        // GET: SampleProfiles/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: SampleProfiles/Create
